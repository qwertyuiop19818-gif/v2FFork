...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/v2crack/ng"
    const val APP_API_URL = "https://api.github.com/repos/v2crack/ng/releases"
    ...
    const val TG_CHANNEL_URL = "https://t.me/v2crackNG"
    const val DELAY_TEST_URL = "https://telegram.org"
